...
#################################################################################################################
RESULTS_FOLDER=~/printer_2_data/config/adxl_results # Path to the folder where storing the results files
SCRIPTS_FOLDER=~/printer_2_data/config/script # Path to the folder where the graph_vibrations.py is located
